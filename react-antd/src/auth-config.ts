 ...
 */
const APP_ID = 'f3f6b298-8968-4290-a585-d180d9bc5950';
...
export const protectedResources = {
  toDoListAPI: {
    endpoint: 'https://localhost:44351/api/am',
    scopes: {
      read: [`api://${APP_ID}/ToDoList.Read`],
      write: [`api://${APP_ID}/ToDoList.ReadWrite`],
    },
  },
};
